...
cd  $2
rm pipeline.config
wget https://raw.githubusercontent.com/alsnac/tf_agroneural/main/pipelinedgx.config
#----------------------------------------------------------------------------------------------------------------------
...
python model_main_tf2.py --model_dir=$4 --pipeline_config_path="$4/pipelinedgx.config"
